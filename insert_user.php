<?php
if(isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['telephone']) && isset($_POST['user_password'])){

// CHECK IF FIELDS ARE NOT EMPTY
    if(!empty(trim($_POST['username'])) && !empty(trim($_POST['user_email'])) && !empty(trim($_POST['telephone'])) && !empty($_POST['user_password'])){
...
// Escape special characters.
        ...
        $telephone = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['telephone']));
...
// INSERT USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, telephone , user_password,) VALUES ('$username', '$user_email', '$telephone', '$user_hash_password')");
